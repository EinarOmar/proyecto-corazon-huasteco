      ...
      <Box sx={{ textAlign: "center", padding: "15px 0"}}>
        <Box sx={{background: "#591D55", padding: "0px", borderRadius: "50px", display: "inline-flex"}}>
            <Box sx={{color: "#A6874E", padding: "7px 14px", borderRadius: "50px"}}>
              <Link style={{textDecoration: "none", color: "#A6874E"}} to="/inicio">Carrusel <ViewCarouselIcon/></Link>
            </Box>
            <Box sx={{background: "#A6874E", padding: "7px 14px", borderRadius: "50px",}}>Mapa <MapIcon/></Box>
        </Box>
      </Box>
